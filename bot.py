...
async def allmenu_handler(event):
    ...
    await event.reply(
        """<blockquote>
╔━═━═「 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 」═━═⪼
║🤖 𝗕𝗼𝘁𝗡𝗮𝗺𝗲 : 𝚄𝚂𝙴𝚁𝙱𝙾𝚃-[𝚅𝚅𝙸𝙿]
║📁 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 : 1.0.2
║👑 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 : @PraiOfficial
║📡 𝗔𝘂𝘁𝗵𝗼𝗿 : Anam-[TZY]
╚━═━═━═━═━═━═━═━═━═━═━═⪼
...
╠━═━═━═━═━═━═━═━═━═━═
║➹ .listserver 
║╰┈➤ cek semua server yang tersedia
║➹ .delserver – id
║╰┈➤ delete server panel
║➹ .cadmin – nama,id
║╰┈➤ create akun admin panel
║➹ .deladmin – id
║╰┈➤ delete akun admin panel
║➹ .listuser 
║╰┈➤ cek semua user yang tersedia
║➹ .listadmin 
║╰┈➤ cek semua admin panel
║
╠━═━═━═━═━═━═━═━═━═━═
║    『 GROUP MENU 』    ║     
╠━═━═━═━═━═━═━═━═━═━═
║➹ .kick – reply atau id
║╰┈➤ keluarkan user dari group
║➹ .promote reply atau id
║╰┈➤ jadikan user admin group
║➹ .demote reply atau id 
║╰┈➤ delete user admin group
║➹ .pin reply pesannya
║╰┈➤ sematkan pesan 
║➹ .unpin reply pesannya
║╰┈➤ batalkan sematkan 
║➹ .liston 
║╰┈➤ cek semua yang online di group
║➹ .mute reply pesannya
║╰┈➤ nonaktifkan user chat di group
║➹ .unmute reply
║╰┈➤ aktifkan user chat di group
║
╠━═━═━═━═━═━═━═━═━═━═
║    『 OTHER MENU 』     ║     
╠━═━═━═━═━═━═━═━═━═━═
...
║➹ .unbl
║➹ .info
║╰┈➤ blokir telegram penggunaa
║➹ .unblock id
║╰┈➤ buka blokiran penggunaa
║
╠━═━═━═━═━═━═━═━═━═━═━═⪼
║    —°𝐀𝐧𝐚𝐦 𝐀𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 -[𝐓𝐙𝐘]   
╚━═━═━═━═━═━═━═━═━═━═━═⪼
...
async def inline_handler(event):
    ...
    caption = """📌 <b>Halo! Selamat datang di Anam Userbot-VVIP</b>
<blockquote>
<u>═━═「 𝗠𝗘𝗡𝗨 & 𝗣𝗔𝗡𝗗𝗨𝗔𝗡 」═━═</u>
...
═══════════════════════════
🚀 Nikmati pengalaman baru dengan Userbot V1.0.2!</blockquote>"""
...
async def inline_handler(event):
    ...
    result = builder.article(
        title="📌 All Menu",
        text=f"""<blockquote>
<b>( ! ) Welcome to Anam Bot Version 1.0.2</b>
...
<b>⚠️ Notes :</b> bot ini hanyalah bot biasa dan gunakan sewajarnya karena ini adalah telegram bukan Whatsapp yang bila kamu terkena blokir akan susah untuk di pulihkan, jika ingin tau lebih lanjut bisa hubungi <a href="https://t.me/PraiOfficial">Owner disini ✨</a>
</blockquote>""",
            buttons=[[Button.inline("⬅ Kembali", data=b"back_main")]],
            parse_mode="html",
            link_preview=False
...
<b>⚠️ Notes :</b> bot ini hanyalah bot biasa dan gunakan sewajarnya karena ini adalah telegram bukan Whatsapp yang bila kamu terkena blokir akan susah untuk di pulihkan, jika ingin tau lebih lanjut bisa hubungi <a href="https://t.me/PraiOfficial">Owner disini ✨</a>
        ...
        await event.edit("""📌 <b>Halo ini adalah menu Anam Bot Version 1.0.2</b>
<blockquote>
...
<b><u>ADA UPDATE APA SAJA DI VERSI 1.0.2 INI?</u></b>
kamu mendapatkan fitur lebih yaitu biaa button dan dapat extra fitur yang dimana fitur ini menyediakan api tertentu dan pastinya sudah di sediakan oleh <a href="https://t.me/PraiOfficial">Anam official</a> pastinya jadi tunggu apalagi cobain fitur baru dari penyedia userbot ini
</blockquote>""",
            buttons=[[Button.inline("⬅ Kembali", data=b"back_main")]],
            parse_mode="html",
            link_preview=False
...
╠━═━═━═━═━═━═━═━═━═━═
║• <b>50 – 130</b> – Ringan 
║╰┈➤ cocok untuk script kecil/personal.  
║• <b>150 – 170</b> – Medium-high 
║╰┈➤ balance antara keamanan & performa.  
║• <b>185+</b> – Sangat tinggi 
║╰┈➤ aman, tapi makin berat dijalankan.  
║• <b>190 – 265</b> – Eksperimental 
║╰┈➤ rawan error, hanya untuk uji ekstrem.  
║
╠━═━═━═━═━═━═━═━═━═━═━═⪼
║    —°𝐀𝐧𝐚𝐦 𝐀𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 -[𝐓𝐙𝐘]   
╚━═━═━═━═━═━═━═━═━═━═━═⪼
...
async def gb1_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            "<blockquote><b>Format salah!</b>\nGunakan:\n`.1gb namapanel,id_tele`\n"
            "Contoh:\n`.1gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    ...
    try:
        ...
        if settings.PP:
            await client.send_file(
                ...
                settings.PP,
                caption=(
                    f"🖥️ 𝗗𝗔𝗧𝗔 𝗣𝗔𝗡𝗘𝗟 𝗨𝗡𝗧𝗨𝗞 {target_id}\n\n"
                    f"🌐 Login: {settings.DOMAIN}\n"
                    f"👤 Username: {user['username']}\n"
                    f"🔐 Password: {password}\n\n"
                    f"⚠️ 𝙽𝙾𝚃𝙴𝚂:\n"
                    f"• Jangan DDoS server\n"
                    f"• Garansi suspend/ddos 3h\n"
                    f"• Claim garansi 1x\n"
                    f"• Sensor domain saat screenshot\n\n"
...
async def gb2_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.2gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "2gb"
...
async def gb3_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.3gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "3gb"
...
async def gb4_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.4gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "4gb"
...
async def gb5_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.5gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "5gb"
...
async def gb6_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.6gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "6gb"
...
async def gb7_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.7gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "7gb"
...
async def gb8_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.8gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "8gb"
...
async def gb10_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.10gb username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "10gb"
...
async def gb_unli_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            ...
            "Contoh:\n`.unli username,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    name = username + "unli"
    ...
    try:
        ...
        server = server_resp.json()["attributes"]
        await event.reply(
            f"✅ 𝗣𝗔𝗡𝗘𝗟 𝗨𝗡𝗟𝗜𝗠𝗜𝗧𝗘𝗗 𝗕𝗘𝗥𝗛𝗔𝗦𝗜𝗟 𝗗𝗜𝗕𝗨𝗔𝗧\n\n"
            f"🆔 ID: {user['id']}\n"
            f"👤 Nama: {username}\n"
            f"📧 Email: {email}\n"
            f"💾 Memory: ∞\n"
...
async def cadmin_handler(event):
    ...
    if not args_text or "," not in args_text:
        return await event.reply(
            "<blockquote><b>Format salah!</b>\nGunakan:\n`.cadmin nama,id`\nContoh:\n`.cadmin adminuser,123456789`</blockquote>",
            parse_mode="html"
        )
    username, target_id = [x.strip() for x in args_text.split(",", 1)]
    email = f"{username}@VinOffcial"
    ...
    try:
        ...
        if settings.PP:
            await user_client.send_file(
                ...
                settings.PP,
                caption=(
                    f"🖥️ 𝗗𝗔𝗧𝗔 𝗔𝗗𝗠𝗜𝗡 𝗨𝗡𝗧𝗨𝗞 {target_id}\n\n"
                    f"🌐 Login: {settings.DOMAIN}\n"
                    f"👤 Username: {user['username']}\n"
                    f"🔐 Password: {password}\n\n"
                    f"⚠️ 𝙽𝙾𝚃𝙴𝚂:\n"
                    f"• Jangan DDoS server\n"
                    f"• Ptpt 1bulan 1x minim 2k\n"
                    f"• Ga ptpt? kick langgar aturan\n"
                    f"• Open ress panel wajib 1group\n"
...
async def done_handler(event):
    ...
    response = (
        ...
        f"<blockquote>📦 <b>𝙱𝙰𝚁𝙰𝙽𝙶 : {name_item}</b>\n"
        f"💸 <b>𝙽𝙾𝙼𝙸𝙽𝙰𝙻 : {price}</b>\n"
        f"🕰️ <b>𝚆𝙰𝙺𝚃𝚄 : {time}</b>\n"
...
async def callback_handler(event):
    ...
    [Button.inline("𝚂𝙷𝚄𝚃𝙳𝙾𝚆𝙽 𝚄𝚂𝙴𝚁𝙱𝙾𝚃", b"shutdown_userbot")]
        ...
        await event.edit(
            """📌 <b>Halo! Selamat datang di Anam Bot</b>
<blockquote>
<u>═━═「 𝗠𝗘𝗡𝗨 & 𝗣𝗔𝗡𝗗𝗨𝗔𝗡 」═━═</u>
Gunakan tombol di bawah untuk menjelajahi semua fitur.  
Fitur terbagi menjadi dua bagian utama:
...
async def help_handler(event):
    ...
    caption = """📌 <b>Halo! Selamat datang di Anam Bot</b>
<blockquote>
<u>═━═「 𝗠𝗘𝗡𝗨 & 𝗣𝗔𝗡𝗗𝗨𝗔𝗡 」═━═</u>
Gunakan tombol di bawah untuk menjelajahi semua fitur.  
Fitur terbagi menjadi dua bagian utama:
